...
<body>
    <div class="topnav" id="myTopnav">
        <a href="http://localhost/activity2/Main.php" class="active"><img src="logo.jpeg"></a>
        ...
        <a href="javascript:alert('This website is only for education purpose only. this only meant for Activity in our Programming I hope We succeed achieving our dreams and not fail to this subject');">About</a>
        <a href="javascript:void(0);" style="font-size:15px;" class="icon" onclick="myFunction()">&#9776;</a>
    </div>
    <br>

    <div class="info">
        <img src="logo.jpeg" alt="logo" class="plmun">
        <br>
        <div class="centered">
            <?php if (!$isLoggedIn): ?>
    ...
    <script>
        $(document).ready(function() {
            $('#login-form').submit(function(event) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'http://localhost/activity2/login.php',
        ...
        function logout() {
            $.ajax({
                type: 'POST',
                url: 'http://localhost/activity2/logout.php',
                success: function() {
